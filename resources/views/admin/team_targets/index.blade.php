        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Team Target Listing</h3>
                </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="form-actions float-right">
                                            ...
                                            <a href="{{route('admin.team-targets.create')}}" class="btn btn-primary">
    ...
    <script>
        $(function () {
            var dataTable = $('.file-export').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.team-targets.index') }}",
                //dom: 'Bfrtip',
                // buttons: [
                //     {
                //         text: 'Delete',
                ...
                swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        /* Read more about isConfirmed, isDenied below */
                            $.ajax({
                                url: '{{route('admin.team-targets.deleteAll')}}',
                                type: 'DELETE',
...
////////////////// Change status by ID //////////
            $(document).on("change", ".switchery", function () {
                ...
                $.ajax({
                    url: '{{route('admin.team-targets.changeStatus')}}',
                    type: 'DELETE',
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
