                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" method="post" action="{{ route('admin.team-targets.update',$teamTarget->id) }}">
                                            @csrf
                                            @method('PATCH')
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="team_id" class="form-control" required>
                                                        ...
                                                        @foreach($teams as $team)
                                                            <option value="{{$team->id}}" @if($teamTarget->team_id == $team->id) selected @endif>{{$team->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('team_id')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name" class="form-control" placeholder="Enter Team Target Name" name="name" value="{{$teamTarget->name}}" required>
                                                    @error('name')
                                                    <label class="danger">{{ $message }}</label>
                                                    @enderror
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="teamDescription" rows="5" class="form-control" name="description" placeholder="Team Target Description">{{$teamTarget->description}}</textarea>
                                                    @error('description')
                                                    <label class="danger">{{ $message }}</label>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 mb-1">
                                                            <div class="input-group">
                                                                ...
                                                                <input id="picker_from" name="start_date" class="form-control datepicker" type="date" value="{{$teamTarget->start_date}}">
                                                            </div>
                                                            @error('start_date')
                                                            <label class="danger">{{ $message }}</label>
                                                            @enderror
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="input-group">
                                                                ...
                                                                <input id="picker_to" name="end_date" class="form-control datepicker" type="date" value="{{$teamTarget->end_date}}">
                                                            </div>
                                                            @error('end_date')
                                                            <label class="danger">{{ $message }}</label>
                                                            @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="amount" class="form-control" maxlength="6" onkeypress="return isNumberKey(this, event);" placeholder="Enter Team Target Amount" name="amount" value="{{$teamTarget->amount}}" required>
                                                    @error('amount')
                                                    <label class="danger">{{ $message }}</label>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="departmentStatus">Team Target Status</label>
                                                    <select name="status" class="form-control">
                                                        <option value="">----- SELECT -----</option>
                                                        <option value="1" @if($teamTarget->status) selected @endif>Enabled</option>
                                                        <option value="0" @if(!$teamTarget->status) selected @endif>Disabled</option>
                                                    </select>
                                                    @error('status')
                                                    <label class="danger">{{ $message }}</label>
                                                    @enderror
