...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Company Listing</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('super-admin.companies.index')}}">Company Listing</a>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <section id="file-export">
        <div class="row">
            ...
            <th>Name</th>
            <th>Status</th>
            <th width="280px" style="text-align: center">Action
            </th>
            </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        $(function () {
            var dataTable = $('.file-export').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('super-admin.companies.index') }}",
                //dom: 'Bfrtip',
                // buttons: [
                //     {
                //         text: 'Delete',
        ...
        $('#delete_record').click(function(){
                ...
                swal({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        /* Read more about isConfirmed, isDenied below */
                            $.ajax({
                                url: '{{route('super-admin.companies.deleteAll')}}',
                                type: 'DELETE',
            ...
            $(document).on("change", ".switchery", function () {
                ...
                $.ajax({
                    url: '{{route('super-admin.companies.changeStatus')}}',
                    type: 'DELETE',
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
