                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('super-admin.users.show',$user->id)}}">User Detail</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">User <small class="text-muted">Detail</small></h4>
                                            ...
                                            <div class="card-body">
                                                <div class="card-text">
                                                    ...
                                                    <dl class="row">
                                                        ...
                                                        <dd class="col-sm-9">{{  $user->status ? 'Enabled':'Disabled' }}</dd>
                                                    </dl>
                                                    ...
                                                    <dl class="row">
                                                        ...
                                                        <dd class="col-sm-9">{{ $user->user->name }}</dd>
                                                    </dl>
