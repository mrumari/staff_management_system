        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Department Listing</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('super-admin.departments.index')}}">Department Listing</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="card-body card-dashboard">
                ...
                <div class="col-md-12">
                    <div class="form-actions float-right">
                        ...
                        <a href="{{route('super-admin.departments.create')}}" class="btn btn-primary">
    ...
    <script>
        ...
        $(function () {
            var dataTable = $('.file-export').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('super-admin.departments.index') }}",
                //dom: 'Bfrtip',
                // buttons: [
                //     {
                //         text: 'Delete',
            ...
            $('#delete_record').click(function(){
                ...
                if(deleteids_arr.length > 0){
                    ...
                    swal({
                        ...
                        $.ajax({
                            url: '{{route('super-admin.departments.deleteAll')}}',
                            type: 'DELETE',
            ...
            $(document).on("change", ".switchery", function () {
                ...
                $.ajax({
                    url: '{{route('super-admin.departments.changeStatus')}}',
                    type: 'DELETE',
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
