                ...
                <div class="breadcrumbs-top float-md-right">
                    <div class="breadcrumb-wrapper mr-1">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('super-admin.departments.create')}}">Add Department</a>
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('super-admin.departments.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="departmentName" class="form-control" placeholder="Department Name" name="name" value="{{ old('name') }}">
                                                @error('name')
                                                <label class="danger">{{ $message }}</label>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea id="departmentDescription" rows="5" class="form-control" name="description" placeholder="Department Description">{{ old('description') }}</textarea>
                                                @error('description')
                                                <label class="danger">{{ $message }}</label>
                                                @enderror
                                            </div>
